...
public interface ActiveMQServerLogger {
   ...
   @LogMessage(id = 222038, value = "Starting paging on address ''{}''; {}", level = LogMessage.Level.WARN)
   ...
   @LogMessage(id = 222148, value = "Message {} has exceeded max delivery attempts. No bindings for Dead Letter Address {} so dropping it", level = LogMessage.Level.WARN)
   void messageExceededMaxDelivery(MessageReference ref, SimpleString name);

   @LogMessage(id = 222149, value = "Message {} has reached maximum delivery attempts, sending it to Dead Letter Address {} from {}", level = LogMessage.Level.WARN)
   void messageExceededMaxDeliverySendtoDLA(MessageReference ref, SimpleString name, SimpleString simpleString);

   @LogMessage(id = 222150, value = "Message {} has exceeded max delivery attempts. No Dead Letter Address configured for queue {} so dropping it", level = LogMessage.Level.WARN)
   ...
   @LogMessage(id = 224108, value = "Stopped paging on address ''{}''; {}", level = LogMessage.Level.WARN)
